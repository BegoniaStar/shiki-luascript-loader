...
if (typeof process === "undefined") {
    ...
    /*
    ** SealDice/Goja build: this branch is unreachable because the runtime
    ** never exposes `process`. Keep the API shape without retaining a Node
    ** filesystem dependency in the bundle.
    */
    const fs = null;
